    ...
    <Box 
      ...
      <Box sx={{ textAlign: 'center', maxWidth: '80%' }}>
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary' }}>
          <br/>
          I am an aspiring game developer with experience as a software developer 
          at a web development company. I have an enthusiasm for VR development and 
          experimenting with immerging technologies to create meaningful experiences.
        </Typography>
        <Typography variant="body1" sx={{ color: 'text.secondary' }}>
          <br/>
          Below you will find links to both a resume and a portfolio of projects I have undertaken.
          <br/>
        </Typography>
      </Box>
      <Box>
